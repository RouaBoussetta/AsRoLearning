...
public class AsRoLearningDBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "AsroQuizLearning";
    ...
    private void setUpQuestions() {
        ...
        questionList.add(new Questions( "What is the benifit of using @VisibleForTesting annotation?","to denote that a class, methods, or field has its visibility relaxed to make code testable","to denote that a class, method, or field is visible only in the test code","to denote that a class, method, or field has its visibility increased to make code less testable","to throw a run-time error if a class, methods, or field with this annotation is accessed improperly","to denote that a class, methods, or field has its visibility relaxed to make code testable",CATEGORY_ANDROID, ""));
        ...
        questionList.add(new Questions("IF the main thread is blocked for too long, the system displays the _ dialog?"," Thread Not Responding","Application Paused"," Application Not Responding","Application Blocked"," Application Not Responding", CATEGORY_ANDROID, ""));
        ...
        questionList.add(new Questions("How do you check that a value is a date object in Node?","until.types.isDate(value)","assert.isDate(value)","console.isDate(value)","util.date(value)","until.types.isDate(value)",CATEGORY_NODE, ""));
