...
public class QuestionsBank {
    ...
    private static List<QuestionsList> AngularQuestions(){
        ...
        final QuestionsList question7=new QuestionsList("In reactive forms, what Angular form class type is used on the native DOM element to wire it up?"," FormArray","FormControl","Properties","Parent","Parent","");
        final QuestionsList question8=new QuestionsList("a"," Plugins","Build","Properties","Parent","Parent","");
        final QuestionsList question9=new QuestionsList("a"," Plugins","Build","Properties","Parent","Parent","");
        final QuestionsList question10=new QuestionsList("a"," Plugins","Build","Properties","Parent","Parent","");
